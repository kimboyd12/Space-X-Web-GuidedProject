...
test("re-renders correctly with the list of missons", () => {
    ...
    // check that there are no missions rendered yet when the component first 
    ...
    // (simulating when the user clicks 'Get Data' and the API data come into the component)
